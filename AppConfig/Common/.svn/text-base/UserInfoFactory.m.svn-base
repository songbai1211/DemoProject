...
@implementation XinYuanUser

@synthesize userId      = _userId;
@synthesize nickName    = _nickName;
@synthesize password    = _password;
@synthesize session     = _session;
@synthesize midPicUrl   = _midPicUrl;
...
+ (NSMutableDictionary *)convertFromUserInfo:(UserInfo *)currentUserInfo
{
    ...
    [dic setObject:(currentUserInfo.isStar ? @"YES" : @"NO") forKey:kLoginInfo_isStar];
...
+ (UserInfo *)userInfoConvertFromDic:(NSMutableDictionary *)userInfoDic
{
    ...
    tempUserInfo.isStar         = [[userInfoDic objectForKey:kLoginInfo_isStar] boolValue];
