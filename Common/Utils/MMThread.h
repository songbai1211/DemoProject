...
#define FOREGROUND_BEGIN	[[ZZTaskQueue sharedInstance] enqueueForeground:^{
#define FOREGROUND_DELAY(x)	[[ZZTaskQueue sharedInstance] enqueueForegroundWithDelay:(dispatch_time_t)x block:^{
#define FOREGROUND_COMMIT	}];

#define BACKGROUND_BEGIN	[[ZZTaskQueue sharedInstance] enqueueBackground:^{
#define BACKGROUND_DELAY(x)	[[ZZTaskQueue sharedInstance] enqueueBackgroundWithDelay:(dispatch_time_t)x block:^{
